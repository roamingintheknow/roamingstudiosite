...
<div className="w-full flex justify-center items-center responsive-top-padding bg-wander-white">
    ...
    <div className="bg-white rounded-xl p-6 w-full shadow-md">
        ...
        {sent ? (
          ...
          <form onSubmit={handleSubmit} className="space-y-4 wander-black-text">
            ...
            <button type="submit" disabled={sending} className="w-full bg-bc-green true-white-text rounded-md py-2 font-semibold hover:bg-wander-white">
  ...
  <h1 className="bc-green-text text-xl font-semibold text-center md:text-right whitespace-nowrap">
    Connect With Us
  </h1>
